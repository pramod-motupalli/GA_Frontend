...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!is_email_verified) {
                ...
                return; // prevent navigation to role-based dashboard
            }
    ...
    return (
        <div className="min-h-screen flex bg-white">
            {/* Left Panel */}
            <div className="w-97 bg-[#EBF4FF] p-10 flex flex-col justify-center items-center">
                <img
                    src="/hands.png"
                    alt="Puzzle Hands"
                    className="w-84 mb-6"
                ...
                <p className="text-gray-600 text-center max-w-md">
                    Our team is built on years of proven experience and a deep
                    commitment to user safety. We combine technical excellence
                    with empathy to deliver secure, reliable solutions. Through
                    strong collaboration and clear communication, we solve
                    challenges with precision and care.
                </p>
            </div>
