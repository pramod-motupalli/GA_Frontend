...
const Dashboard = () => {
  return (
    <div className="w-full h-screen relative bg-white overflow-hidden">
      <div className="w-1/6 h-screen pb-6 left-[18px] top-[25px] absolute bg-white rounded-2xl shadow-[0px_0px_10px_0px_rgba(64,108,140,0.20)] outline outline-1 outline-offset-[-1px] outline-zinc-500/10 flex flex-col justify-between items-center overflow-hidden">
